...
const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <a
      ...
      aria-label={language === 'ar' ? 'تواصل مع دعم ODMSYNC على واتساب' : 'Chat with ODMSYNC Support on WhatsApp'}
      title={language === 'ar' ? 'تواصل مع دعم ODMSYNC' : 'Chat with ODMSYNC Support'}
    >
      ...
      <span className="font-bold text-sm hidden md:inline whitespace-nowrap">
        {language === 'ar' ? 'دعم ODMSYNC' : 'Chat with ODMSYNC Support'}
      </span>
    </a>
  );
};
