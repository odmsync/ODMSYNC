...
export const TESTIMONIALS_EN: Testimonial[] = [
  {
    ...
    location: "Tripoli",
    role: "Home User",
    text: "Finally! Internet that works during power cuts. My kids can do online school and I can work from home. ODMSYNC changed everything for us in Tripoli.",
    stars: 5
  },
  {
    name: "Fatima",
    ...
    text: "My shop in Mina needed reliable internet for payments and inventory. ODMSYNC installed in 2 days and it's been perfect. No more lost sales due to connection issues!",
    stars: 5
  },
  {
    name: "Omar",
    ...
    text: "I was getting 10 Mbps before. Now I have 100 Mbps stable, even during peak hours. Gaming is smooth, no lag. Best decision I made this year.",
    stars: 5
  },
  {
    name: "Layla",
    location: "Qalamoun",
    role: "Teacher",
    text: "Online teaching requires stable connection. ODMSYNC never lets me down. My students can hear me clearly and I can share videos without buffering. Highly recommend!",
    stars: 5
  }
];
...
export const TESTIMONIALS_AR: Testimonial[] = [
  {
    ...
    location: "طرابلس",
    role: "مستخدم منزلي",
    text: "أخيراً! إنترنت شغال وقت القطعة. أولادي يقدرون يدرسوا أونلاين وأنا أقدر أشغل من البيت. ODMSYNC غيرت كل شي عندنا بطرابلس.",
    stars: 5
  },
  {
    name: "فاطمة",
    location: "المينا",
    role: "صاحبة محل",
    text: "المحل عندي بالمينا محتاج إنترنت موثوق للدفع والمخزون. ODMSYNC ركبوا خلال يومين وكل شي ممتاز. ما في خسارة مبيعات من ورا النت!",
    stars: 5
  },
  {
    name: "عمر",
    location: "دام و فرز",
    role: "لاعب ألعاب",
    text: "كنت آخذ 10 ميقا قبل. الآن عندي 100 ميقا ثابتة حتى وقت الذروة. الألعاب سلسة، ما في lag. أحسن قرار عملته بهالسنة.",
    stars: 5
  },
  {
    name: "ليلى",
    location: "القلمون",
    role: "معلمة",
    text: "التدريس أونلاين محتاج اتصال مستقر. ODMSYNC ما خذلتني أبداً. طلابي يسمعوني واضح وأقدر أشارك فيديوهات بدون تقطيع. بنصح فيها كتير!",
    stars: 5
  }
];
